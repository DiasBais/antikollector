  ...
  <div class="step5">
    <div class="step5__content">
      ...
      <div class="step5__body">
        <p>В сенсорной панели Qiwi/Kassa24 терминала нажать на «Оплату услуг».</p>
        <p>Введите в поиске "Антиколлектор" или же оплатите через карточкой</p>
        <p>Ввести свой ИИН и нажать на кнопку Вперед</p>
        <p>Перепроверить верно ли введен ИИН заемщика, для подтверждения данных нажать на кнопку Вперед.</p>
        <p>Внесите сумму в купюроприемник терминала «Qiwi/Kassa24» и нажать на кнопку Оплатить.</p>
      </div>
